...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center px-3 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
    ...
    >
      {darkMode ? (
        <>
          ...
          <span className="text-sm font-medium text-gray-800">浅色模式</span>
        </>
      ) : (
        <>
